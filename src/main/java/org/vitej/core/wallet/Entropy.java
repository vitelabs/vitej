 ...
 * 
 * copy from https://github.com/web3j/web3j/blob/master/crypto/src/main/java/org/web3j/crypto/MnemonicUtils.java
 * 
...
public class Entropy {
     ...
     */
    public static String toMnemonic(byte[] initialEntropy) {
